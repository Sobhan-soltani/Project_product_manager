# Temporarily disabled in-memory InventoryManager to focus on database-backed storage.
# This will be updated to use ProductRepository once repository code is reviewed.
"""
